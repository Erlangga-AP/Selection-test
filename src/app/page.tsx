...
export default function Home() {
  const defaultDominoes: [number, number][] = [
    [6, 1],
    [4, 3],
    [5, 1],
    [3, 4],
  ...
  const [dominoes, setDominoes] =
    useState<Array<[number, number]>>(defaultDominoes);
    ...
    <div className="max-w-2xl p-8 mx-auto">
      ...
      <div className="flex flex-col gap-2 w-full max-w-[200px]">
        ...
        <button
          ...
          className="bg-blue-400 text-white px-3 py-1 rounded self-start"
        >
          Remove
        </button>
      </div>
